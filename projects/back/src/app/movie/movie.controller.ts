...
export class MovieController {
    ...
    @Put('like/:movieId')
    async likeOrUnlikeMovie(@Param() params: LikeOrUnlikeMovieDto , @Req() request: CustomFastifyRequest): Promise<{status : 'LIKE' | 'DISLIKE'}>{
        return await this.movieService.likeOrUnlikeMovie(request.user.id, params.movieId)
    }
